...
# The default is the same as orientation, if supported.
# Supported values are: unspecified, behind, landscape, portrait, reverseLandscape,
# reversePortrait, sensorLandscape, sensorPortrait, userLandscape, userPortrait,
